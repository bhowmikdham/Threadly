              ...
              "Statement": [
                {
                  ...
                  "Resource": {
                    "Fn::Sub": "arn:${AWS::Partition}:bedrock:${AWS::Region}:${AWS::AccountId}:inference-profile/au.anthropic.claude-haiku-4-5-20251001-v1:0"
                  }
                },
                {
                  "Effect": "Allow",
                  ...
                  "Resource": [
                    {
                      "Fn::Sub": "arn:${AWS::Partition}:bedrock:ap-southeast-2::foundation-model/anthropic.claude-haiku-4-5-20251001-v1:0"
                    },
                    {
                      "Fn::Sub": "arn:${AWS::Partition}:bedrock:ap-southeast-4::foundation-model/anthropic.claude-haiku-4-5-20251001-v1:0"
                    }
                  ],
                  "Condition": {
                    "StringEquals": {
